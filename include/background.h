...
struct background
{
  ...
  double Omega0_anq;       /**< \f$ \Omega_{0 anq} \f$: anisotropic quintaessence */  
  double Omega0_sde;       /**< \f$ \Omega_{0 sd} \f$: solid dark energy */  
  double Omega0_a2f;       /**< \f$ \Omega_{0 a2f} \f$: anisotropic 2-form */    
  double Omega0_eymh;      /**< \f$ \Omega_{0 eymh} \f$: Einstein Yang-Mills Higgs*/          
  double Omega0_avf;       /**< \f$ \Omega_{0 avf} \f$: anisotropic vector field */   
  ...
  double anq_parameters_1;  /* \lambda,  anisotropic quintessence */
  double anq_parameters_2;  /*  \mu,  anisotropic quintessence */
  double anq_parameters_3;  /*   yini -> y initial condition */

  double sde_parameters_1;  /* n Parameters of the solid dark energy */
  double sde_parameters_2;  /* m Parameters of the solid dark energy*/
  double sde_parameters_3;  /* f_ini initial conditiond for f1 and f2*/

  double a2f_parameters_1;  /* \lambda, Parameters of the Anisotropic 2-form */
  double a2f_parameters_2;  /* \mu, Parameters of the Anisotropic 2-form */
  double a2f_parameters_3;  /* zeta_ini  -> z initial condition */
  double a2f_parameters_4;  /* \Omeba_{B,ini}  -> \Omega_{B } initial condition */ 

  double eymh_parameters_1;  /* \alpha, Parameters of the Einstein Yang-Mills Higgs */
  double eymh_parameters_2;  /* v_ini -> v initial condition */
  double eymh_parameters_3;  /* w_ini -> w initial condition */

  double avf_parameters_1;  /* \lambda,  anisotropic quintessence */
  double avf_parameters_2;  /*  vini ->  v initial condition */  

  double sigma0_shear;      /* observable anisotropy  */    
  double log_sigma0_shear;  /* Log(sigma_0_shear)     */      
  ...
  int index_bg_x_anq;         /**< x  */
  int index_bg_y_anq;         /**< y  */           
  int index_bg_z_anq;         /**< z  */         
  int index_bg_s_anq;         /**< shear */
  int index_bg_rho_anq;       /**< quintaessence energy density */
  int index_bg_p_anq;         /**< quintaessence pressure */ 

  int index_bg_f1_sde;         /**< f2  */
  int index_bg_f2_sde;         /**< f2 */         
  int index_bg_s_sde;         /**< shear */
  int index_bg_rho_sde;       /**< solid energy density */
  int index_bg_p_sde;         /**< solid pressure */ 

  int index_bg_x1_a2f;         /**< x_{1} \propto \dot{\phi}} */
  int index_bg_x2_a2f;         /**< x_{2} \propto \sqrt{V} */        
  int index_bg_s_a2f;          /**< shear */
  int index_bg_OmB_a2f;        /**< 2-form energy density */ 
  int index_bg_rho_a2f;       /**< anisotropic dark energy density */
  int index_bg_p_a2f;         /**< anisotropic dark energy pressure */   

  int index_bg_x_eymh;         /**< x  */
  int index_bg_y_eymh;         /**< y  */  
  int index_bg_xi_eymh;        /**< \xi  */
  int index_bg_pp_eymh;        /**< p  */
  int index_bg_sp_eymh;        /**< s  */   
  int index_bg_v_eymh;         /**< v  */ 
  int index_bg_wp_eymh;        /**< w  */
  int index_bg_z_eymh;         /**< z  */
  int index_bg_s_eymh;         /**< shear */
  int index_bg_rho_eymh;       /**< Yang-Mill energy density */
  int index_bg_p_eymh;         /**< Yang-Mill pressure */   

  int index_bg_z_avf;         /**< x  */
  int index_bg_v_avf;         /**< y  */           
  int index_bg_x_avf;         /**< z  */         
  int index_bg_s_avf;         /**< shear */
  int index_bg_rho_avf;       /**< vector field energy density */
  int index_bg_p_avf;         /**< vector field pressure */ 
  ...
  int index_bi_x_anq;        /**< {B} x */
  int index_bi_y_anq;        /**< {B} y */
  int index_bi_z_anq;        /**< {B} z */ 
  int index_bi_s_anq;        /**< {B} shear */

  int index_bi_f1_sde;        /**< {B} f1 */
  int index_bi_f2_sde;        /**< {B} f2 */ 
  int index_bi_s_sde;        /**<  {B}  shear */ 

  int index_bi_x1_a2f;       /**< {B} x1 */
  int index_bi_x2_a2f;       /**< {B} x2 */ 
  int index_bi_s_a2f;        /**< {B} shear*/
  int index_bi_OmB_a2f;      /**< {B} \Omega_{B} */

  int index_bi_x_eymh;       /**< {B} x */
  int index_bi_y_eymh;       /**< {B} y */ 
  int index_bi_xi_eymh;      /**< {B} \xi */
  int index_bi_pp_eymh;      /**< {B} p */ 
  int index_bi_sp_eymh;      /**< {B} s */ 
  int index_bi_v_eymh;       /**< {B} v */
  int index_bi_wp_eymh;      /**< {B} w */
  int index_bi_z_eymh;       /**< {B} z */
  int index_bi_s_eymh;       /**< {B} shear */   

  int index_bi_z_avf;        /**< {B} z */
  int index_bi_v_avf;        /**< {B} v */
  int index_bi_x_avf;        /**< {B} x */ 
  int index_bi_s_avf;        /**< {B} shear */     
  ...
  short has_anq;       /**< presence of anisotropic quintesence? */  
  short has_sde;       /**< presence of solid field? */  
  short has_a2f;       /**< presence of anisotropic 2-form? */ 
  short has_eymh;      /**< presence of Einstein Yang-Mills Higgs? */
  short has_avf;       /**< presence of anisotropic vector field? */             
