...
cdef extern from "class.h":
    ...
    cdef struct background:
        ...
        double Omega0_anq
        double anq_parameters_1
        double anq_parameters_2
        double anq_parameters_3  
        double Omega0_sde
        double sde_parameters_1
        double sde_parameters_2
        double sde_parameters_3  
        double Omega0_a2f        
        double a2f_parameters_1
        double a2f_parameters_2
        double a2f_parameters_3  
        double Omega0_eymh
        double eymh_parameters_1
        double eymh_parameters_2
        double eymh_parameters_3   
        double Omega0_avf
        double avf_parameters_1
        double avf_parameters_2
        double sigma0_shear  
        double log_sigma0_shear     
        double Omega0_fld
        double w0_fld
        double wa_fld
        double cs2_fld
