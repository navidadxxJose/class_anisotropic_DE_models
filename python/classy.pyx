...
cdef class Class:
    ...
    def Omega_anq(self):
        return self.ba.Omega0_anq  

    def Omega_sde(self):
        return self.ba.Omega0_sde 

    def Omega_a2f(self):
        return self.ba.Omega0_a2f

    def Omega_eymh(self):
        return self.ba.Omega0_eymh    

    def Omega_avf(self):
        return self.ba.Omega0_avf                                      
   ...
   #################################
    ...
    def get_current_derived_parameters(self, names):
        ...
        for name in names:
            ...
            elif name == 'Omega0_anq' or name == 'Omega_anq':
                value = self.ba.Omega0_anq
            elif name == 'Omega0_sde' or name == 'Omega_sde':
                value = self.ba.Omega0_sde     
            elif name == 'Omega0_a2f' or name == 'Omega_a2f':
                value = self.ba.Omega0_a2f
            elif name == 'Omega0_eymh' or name == 'Omega_eymh':
                value = self.ba.Omega0_eymh   
            elif name == 'Omega0_avf' or name == 'Omega_avf':
                value = self.ba.Omega0_avf                                                           
            elif name == 'sigma0_shear':
                value = self.ba.sigma0_shear                                   
            elif name == 'log_sigma0_shear':
                value = self.ba.log_sigma0_shear                  
            elif name == 'age':
                value = self.ba.age
            ...
            ### CMB distance priors ###
                ...
                value = pow(self.ba.Omega0_m, 0.5)*self.ba.h*100*(1.+self.th.z_star)*self.th.da_star/299792.458
            elif name == 'la_cmb':
                value = 3.14159265*(1.+self.th.z_star)*self.th.da_star/self.th.rs_star
            ### CMB distance priors ###                
            elif name == 'n_e':
                value = self.th.n_e
            elif name == 'A_s':
